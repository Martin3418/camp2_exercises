...
class App extends React.Component {
  constructor(props) {
    super(props)
    this.state = {products: products, sort: "desc"}
  }
  sortBy = column => {
    const asc = _.sortBy(this.state.products, column);
    const desc = _.sortBy(this.state.products, column).reverse();

    let sortedValues = this.state.products;
      ...
      this.setState({products : sortedValues});
  }
  ...
  render() {
    return (
      ...
      <thead>
      <tr>
      <th scope="col" onClick={this.sortBy.bind(this, "decathlon_id")}>Code art.</th>
      <th scope="col" onClick={this.sortBy.bind(this, "title")}>Description art</th>
      <th scope="col" onClick={this.sortBy.bind(this, "price")}>Prix</th>
      </tr>
      </thead>
      <tbody>
